...
public class ReleaseBean {
    ...
    private String release_user_img;
    ...
    public ReleaseBean(int id, int user_id, String release_type, String release_title, String release_desc, int release_count, Double release_price, String release_contact, String release_user_img, String release_time) {
        this.release_id = id;
        ...
        this.release_user_img = release_user_img;
    ...
    public String getRelease_user_img() {
        return release_user_img;
    }

    public void setRelease_user_img(String release_user_img) {
        this.release_user_img = release_user_img;
    }
    ...
    public String toString() {
        return "ReleaseBean{" +
                ...
                ", release_user_img='" + release_user_img + '\'' +

...
public class AddressBean {
    ...
    public AddressBean(int address_id, int address_user_id, String address_name, String address_phone, String address_content, String address_default, String address_area) {

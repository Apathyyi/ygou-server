...
public class EvaluateBean {
    ...
    public EvaluateBean(int evl_id, int evl_user_id, int evl_order_id, String evl_content, String evl_goods_img, String evl_goods_name, String evl_goods_price, String evl_location, String evl_time) {
        this.evl_id = evl_id;
